...
public class ViewFlipperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < data.size(); i = i + 2) {
            ...
            tv1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(ViewFlipperActivity.this, "text" + v.getTag(), Toast
                            .LENGTH_SHORT).show();
                }
            });
            tv2.setTag(i + 1);
        ...
        //            @Override
        //            public void onClick(View v) {
        //                Log.i("SecondActivity", "---onClick()--->" + mUPMarqueeView
        // .getChildCount());
        //                Log.i("SecondActivity", "---onClick()--->" + mUPMarqueeView
        // .getCurrentView()
        //                        .getTag());
        //                Toast.makeText(ViewFlipperActivity.this, "text" + mUPMarqueeView
        // .getCurrentView()
